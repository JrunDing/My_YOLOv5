...
if __name__ == "__main__":
    ...
    mixup               = True
    mixup_prob          = 0.5
    special_aug_ratio   = 0.7 # 控制使用mosic增强的epoch数
    #------------------------------------------------------------------#
    #   label_smoothing     标签平滑。一般0.01以下。如0.01、0.005。
    #------------------------------------------------------------------#
    label_smoothing     = 0.01 # 原为0   提高泛化能力
    ...
    Init_Epoch          = 0
    Freeze_Epoch        = 50
    Freeze_batch_size   = 16 # Freeze_batch_size建议为Unfreeze_batch_size的1-2倍
    #------------------------------------------------------------------#
    #   解冻阶段训练参数
